namespace TRXToHTMLConvert
{
    ...
    /// root class of model
    /// </summary>
    public class TheTestReportModel
    {
        public string StartTime { get; set; }
        public TestReportSummaryModel Summary { get; set; }
        public List<TheTestReportClassModel> TestClasses { get; set; }
    }

    /// <summary>
    /// report test class
    /// </summary>
    public class TheTestReportClassModel
    {
        public string ClassName { get; set; }
        public List<TestReportResultModel> TestResults { get; set; }
    }

    /// <summary>
    /// report test result
    /// </summary>
    public class TestReportResultModel
    {
